...
- 🔀 &nbsp; A [GitHub Actions Workflow](https://github.com/stephendolan/better-gmail-filters/blob/main/.github/workflows/automerge.yml) to handle auto-merging dependency updates
