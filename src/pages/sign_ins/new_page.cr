class SignIns::NewPage < AuthLayout
  ...
  def content
    div class: "max-w-lg mx-auto my-20" do
      link OAuth::Google::Connect, class: "w-full inline-flex justify-center py-2 px-4 space-x-2 border border-gray-400 rounded-md shadow-sm bg-white text-sm font-medium text-gray-900 hover:bg-gray-50" do
        span "Sign in with "
