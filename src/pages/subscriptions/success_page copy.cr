    ...
    section class: "bg-primary-700", data_controller: "confetti" do
      div class: "max-w-2xl mx-auto text-center py-16 sm:py-28 md:py-44 px-4 sm:px-6 lg:px-8" do
        ...
        div class: "w-full mx-auto mt-8 flex flex-col space-y-2 sm:flex-row sm:space-x-2 sm:space-y-0" do
          link "Explore Videos", Videos::Index, class: "flex-1 inline-flex items-center justify-center px-5 py-3 border border-transparent text-base font-medium rounded-md text-primary-700 bg-white hover:bg-primary-50 sm:w-auto"
